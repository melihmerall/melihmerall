...
<picture>
  ...
  <img alt="Melih Meral — Senior Software Developer" src="./assets/hero-dark.svg" width="100%">
</picture>
...
<table>
  <tr>
    ...
    <td><img src="https://skillicons.dev/icons?i=dotnet,cs,nodejs,nestjs&theme=dark" alt="Backend"/></td>
    <td>.NET 10 · ASP.NET Core · EF Core + Dapper · Clean Architecture · CQRS (MediatR) · Hangfire</td>
  </tr>
  <tr>
    <td><b>Frontend</b></td>
    <td><img src="https://skillicons.dev/icons?i=react,nextjs,ts,tailwind&theme=dark" alt="Frontend"/></td>
    <td>Next.js App Router · Server Components · TypeScript strict · Zustand + React Query</td>
  </tr>
  <tr>
    <td><b>Data</b></td>
    <td><img src="https://skillicons.dev/icons?i=postgres,mysql,redis,elasticsearch&theme=dark" alt="Data"/></td>
    <td>SQL Server · PostgreSQL · Supabase (RLS, Realtime) · Redis · Elasticsearch</td>
  </tr>
  <tr>
    <td><b>Distributed</b></td>
    <td><img src="https://skillicons.dev/icons?i=rabbitmq,kubernetes&theme=dark" alt="Distributed"/></td>
    <td>RabbitMQ + MassTransit · Outbox & Saga · gRPC · YARP API Gateway</td>
  </tr>
  <tr>
    <td><b>Cloud & Ops</b></td>
    <td><img src="https://skillicons.dev/icons?i=docker,azure,githubactions,vercel&theme=dark" alt="Cloud"/></td>
    <td>Multi-stage Docker · AKS + Helm · blue-green deploys · IIS / Plesk · Vercel</td>
  </tr>
  <tr>
    <td><b>Observability</b></td>
    <td><img src="https://skillicons.dev/icons?i=grafana,prometheus&theme=dark" alt="Observability"/></td>
...
<picture>
  ...
  <img alt="Contribution snake" src="https://raw.githubusercontent.com/melihmerall/melihmerall/output/github-snake-dark.svg">
</picture>
